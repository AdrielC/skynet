package exd.fundamenski.skynet.service.config

import exd.fundamenski.skynet.default
import exd.fundamenski.skynet.domain.ExecStrategy
import exd.fundamenski.skynet.util.threads
